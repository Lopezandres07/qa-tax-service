...
Then(
  ...
  async function (gclid, fbclid) {
    // Se valida que los datos de tracking se envían correctamente al servidor, lo cual se puede simular validando que se almacenan en localStorage o que se incluyen en la URL de redirección
    const checkout = new CheckoutPage(this.page)
